<?php
	 $json_string3 = file_get_contents("http://api.wunderground.com/api/ecadb96c07edbcad/almanac/q/ID/Semarang.json");
	$json_string1 = file_get_contents("http://api.wunderground.com/api/ecadb96c07edbcad/astronomy/q/IA/Mugas.json");
	$json_string2 = file_get_contents("http://api.wunderground.com/api/ecadb96c07edbcad/planner_07010731/q/IA/Mugas.json");
 ...
 $json_string = file_get_contents("http://api.wunderground.com/api/ecadb96c07edbcad/geolookup/conditions/q/IA/Cedar_Rapids.json");
